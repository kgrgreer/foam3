...
import Foundation
public class Repeat: ProxyParser {
...
super.set(key: key, value: value)
  ...
  private class ClassInfo_: ClassInfo {
    ...
    lazy var id: String = "foam.swift.parse.parser.Repeat"

    lazy var label: String = "Repeat"

    lazy var parent: ClassInfo? = ProxyParser.classInfo()

    lazy var ownAxioms: [Axiom] = [DELIM,MIN,MAX,PARSE]

    lazy var cls: AnyClass = Repeat.self

    func `create`(args: [String:Any?] = [:], x: Context) -> Any {
      return Repeat(args, x)
    }
