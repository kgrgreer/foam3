...
import Foundation
public class BooleanParser: ProxyParser {
...
return Alt(["parsers": [
  ...
  public override func `ownClassInfo`() -> ClassInfo {
    return BooleanParser.classInfo_
  }
...
super.set(key: key, value: value)
  ...
  private class ClassInfo_: ClassInfo {
    ...
    lazy var id: String = "foam.swift.parse.json.BooleanParser"

    lazy var label: String = "Boolean Parser"

    lazy var parent: ClassInfo? = ProxyParser.classInfo()

    lazy var ownAxioms: [Axiom] = [DELEGATE]

    lazy var cls: AnyClass = BooleanParser.self

    func `create`(args: [String:Any?] = [:], x: Context) -> Any {
      return BooleanParser(args, x)
    }
