...
import Foundation
public class NotChars: AbstractFObject, Parser {
...
fatalError("No default value for chars")
...
super.set(key: key, value: value)
  ...
  private class ClassInfo_: ClassInfo {
    ...
    lazy var id: String = "foam.swift.parse.parser.NotChars"

    lazy var label: String = "Not Chars"

    lazy var parent: ClassInfo? = nil

    lazy var ownAxioms: [Axiom] = [CHARS,PARSE]

    lazy var cls: AnyClass = NotChars.self

    func `create`(args: [String:Any?] = [:], x: Context) -> Any {
      return NotChars(args, x)
    }
