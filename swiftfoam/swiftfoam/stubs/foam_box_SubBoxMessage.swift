...
import Foundation
public class SubBoxMessage: Message {
...
return ""
  ...
  public override func `ownClassInfo`() -> ClassInfo {
    return SubBoxMessage.classInfo_
  }
...
super.set(key: key, value: value)
  ...
  private class ClassInfo_: ClassInfo {
    ...
    lazy var id: String = "foam.box.SubBoxMessage"

    lazy var label: String = "Sub Box Message"

    lazy var parent: ClassInfo? = Message.classInfo()

    lazy var ownAxioms: [Axiom] = [NAME]

    lazy var cls: AnyClass = SubBoxMessage.self

    func `create`(args: [String:Any?] = [:], x: Context) -> Any {
      return SubBoxMessage(args, x)
    }
