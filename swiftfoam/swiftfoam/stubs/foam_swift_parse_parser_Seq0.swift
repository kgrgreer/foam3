...
import Foundation
public class Seq0: AbstractFObject, Parser {
...
super.set(key: key, value: value)
  ...
  private class ClassInfo_: ClassInfo {
    ...
    lazy var id: String = "foam.swift.parse.parser.Seq0"

    lazy var label: String = "Seq0"

    lazy var parent: ClassInfo? = nil

    lazy var ownAxioms: [Axiom] = [PARSERS,PARSE]

    lazy var cls: AnyClass = Seq0.self
