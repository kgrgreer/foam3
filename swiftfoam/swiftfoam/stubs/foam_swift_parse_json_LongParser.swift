...
import Foundation
public class LongParser: AbstractFObject, Parser {
...
super.set(key: key, value: value)
  ...
  private class ClassInfo_: ClassInfo {
    ...
    lazy var id: String = "foam.swift.parse.json.LongParser"

    lazy var label: String = "Long Parser"

    lazy var parent: ClassInfo? = nil

    lazy var ownAxioms: [Axiom] = [PARSE]

    lazy var cls: AnyClass = LongParser.self

    func `create`(args: [String:Any?] = [:], x: Context) -> Any {
      return LongParser(args, x)
    }
