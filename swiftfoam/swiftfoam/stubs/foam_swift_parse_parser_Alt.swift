...
import Foundation
public class Alt: AbstractFObject, Parser {
...
super.set(key: key, value: value)
  ...
  private class ClassInfo_: ClassInfo {
    ...
    lazy var id: String = "foam.swift.parse.parser.Alt"

    lazy var label: String = "Alt"

    lazy var parent: ClassInfo? = nil

    lazy var ownAxioms: [Axiom] = [PARSERS,PARSE]

    lazy var cls: AnyClass = Alt.self
