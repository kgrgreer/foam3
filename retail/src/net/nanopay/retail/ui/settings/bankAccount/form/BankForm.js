...
foam.CLASS({
  ...
  methods: [
    function init() {
      this.views = [
        { parent: 'addBank', id: 'form-addBank-info',         label: 'Account info',  view: { class: 'net.nanopay.retail.ui.settings.bankAccount.form.BankInfoForm' } },
        { parent: 'addBank', id: 'form-addBank-verification', label: 'Verification',  view: { class: 'net.nanopay.retail.ui.settings.bankAccount.form.BankVerificationForm' } },
        { parent: 'addBank', id: 'form-addBank-cashout',      label: 'Cashout plan',  view: { class: 'net.nanopay.retail.ui.settings.bankAccount.form.BankCashoutForm' } },
        { parent: 'addBank', id: 'form-addBank-done',         label: 'Done',          view: { class: 'net.nanopay.retail.ui.settings.bankAccount.form.BankDoneForm' } }
      ];
      this.SUPER();
    }
  ],
