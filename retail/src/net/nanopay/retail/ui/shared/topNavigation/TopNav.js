    ...
    function initE(){
      this
        ...
        .start('div').addClass('topNavContainer')
          .start({class: 'net.nanopay.retail.ui.shared.topNavigation.BusinessLogoView', data: this.data})
          .end()
          .start({class: 'foam.nanos.menu.MenuBar'}).addClass('menuBar')
          .end()
          .start({class: 'net.nanopay.retail.ui.shared.topNavigation.UserTopNavView'})
          .end()
        .end()
    }
  ]
