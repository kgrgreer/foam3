    ...
    function initE() {
      ...
      this
        ...
        .start().addClass('blue-card-title')
          .add(this.title)
          .start().addClass('thin-align').add(this.formattedPayableAmount$).style({ 'font-weight': '100', 'margin': '10px 0 0 0', 'font-size': '14px' }).end() 
        .end()
        ...
        .tag({ class: 'net.nanopay.b2b.ui.shared.summaryViews.SummaryCard', count$: this.newCount$, amount$: this.newAmount$, status: this.newLabel })
