foam.CLASS({
  ...
  name: 'FailedIPLoggingAuthService',
  extends: 'foam.nanos.auth.ProxyAuthService',

  documentation: `Service that records request IP address when login is
    attempted for users who entered the incorrect password.`,
