foam.CLASS({
  ...
  methods: [
    ...
    function validatePADAuthInfo() {
      ...
      if ( ! this.validatePostalCode(this.userAddress.postalCode, this.userAddress.countryId) && ! this.validatePostalCode(bankAddress.postalCode, bankAddress.countryId) ) {
