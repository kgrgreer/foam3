foam.CLASS({
  ...
  messages: [
    ...
    { name: 'Instructions1',  message: 'We have debited and credited an amount btween $0.01 - $0.99 to the account you have provided. The amount will appear in your account 2-3 business days from the account creation date.' },
