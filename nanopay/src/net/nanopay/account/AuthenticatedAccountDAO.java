    ...
    extends ProxyDAO
{
  ...
  public FObject find_(X x, Object id) {
    ...
    if ( account != null && ! SafetyUtil.equals(account.getOwner(), user.getId()) && ! auth.check(x, GLOBAL_ACCOUNT_READ) ) {
      return null;
    }
  ...
  public FObject remove_(X x, FObject obj) {
    ...
    if ( account != null && ! SafetyUtil.equals(account.getOwner(), user.getId()) && ! auth.check(x, GLOBAL_ACCOUNT_DELETE) ) {
