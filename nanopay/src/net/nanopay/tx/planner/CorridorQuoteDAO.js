  ...
  methods: [
    {
      ...
      javaCode: `
        ...
        if ( quote.getRequestTransaction() instanceof CreditCodeTransaction && quote.getSourceAccount() instanceof AbstractCreditCodeAccount && quote.getDestinationAccount() instanceof AbstractCreditCodeAccount) {
