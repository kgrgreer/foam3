  ...
  methods: [
    ...
    },
    {
      ...
      if ( fx != null && fx.size() > 0 ) {
        ...
        fxSummary.setRate(formatRate(fxRate, source, destination, 4));
        fxSummary.setInverseRate(formatRate(1.0 / fxRate, destination, source, 4));
