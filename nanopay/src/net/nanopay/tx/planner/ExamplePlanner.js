...
/*
  ...
  planner logic gives you the following arguments:
      1. x  - The Context
  ...
  You must return a tranasction object from the plannerLogic method. This gets added as a plan to the quote automatically.
  ...
  methods: [
    {
      ...
      javaCode: `
        ...
        addTransfer(sender, -(amount + 1) );
        addTransfer(destination, amount);
