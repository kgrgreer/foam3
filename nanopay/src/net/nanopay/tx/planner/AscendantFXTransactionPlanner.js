...
foam.CLASS({
  ...
  methods: [
    ...
    },
    {
      ...
      if ( null != transaction.getReferenceData() ) {
        for ( Object obj : transaction.getReferenceData().values() ) {
    ...
    },
    {
      ...
      javaCode: `
        ...
        if ( null != request.getReferenceData() ) {
          for ( Object obj : request.getReferenceData().values() ) {
