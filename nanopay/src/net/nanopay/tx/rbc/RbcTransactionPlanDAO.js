foam.CLASS({
  ...
  methods: [
    ...
    if ( request instanceof RbcVerificationTransaction ) {
    ...
    if ( sourceAccount instanceof CABankAccount &&
      ...
      if ( ! useRbcAsPaymentProvider(x, (BankAccount) sourceAccount) ) return this.getDelegate().put_(x, obj);
      ...
      if ( ! useRbcAsPaymentProvider(x, (BankAccount) destinationAccount) ) return this.getDelegate().put_(x, obj);
