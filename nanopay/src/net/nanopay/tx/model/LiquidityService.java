...
public class LiquidityService
    ...
    implements LiquidityAuth, NanoService {
  ...
  protected DAO getLiquiditySettingsDAO() {
    if ( liquiditySettingsDAO_ == null ) {
      liquiditySettingsDAO_ = (DAO) getX().get("liquiditySettingsDAO");
    }
   ...
   */
  public FObject addCICOTransaction(long userId, long amount, long bankAccountId, TransactionType transactionType, X
      x) throws
      RuntimeException {
  ...
  public long getCashInAmount(Long payerId, Long payerMinBalance) {
    ...
    for ( Object object : pendingBalanceList.getArray() ) {
      ...
      if ( transaction.getStatus().equals(TransactionStatus.COMPLETED) || transaction.getStatus().equals
