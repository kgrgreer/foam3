FOAM_FILES([
  ...
  { name: 'net/nanopay/account/ui/addAccountModal/accountType/accounts/AddShadowAccount', flags: ['web'] },
  { name: 'net/nanopay/account/ui/addAccountModal/accountType/accounts/AddVirtualAccount', flags: ['web'] },
  { name: 'net/nanopay/account/ui/addAccountModal/accountType/accounts/AddAggregateAccount', flags: ['web'] },
  ...
  { name: 'net/nanopay/account/ui/addAccountModal/liquidityRule/LiquidityRules', flags: ['web'] },
  { name: 'net/nanopay/account/ui/addAccountModal/liquidityRule/LiquidityRuleSaveTemplate', flags: ['web'] },
  { name: 'net/nanopay/account/ui/addAccountModal/liquidityRule/LiquidityRuleSelected', flags: ['web'] },
