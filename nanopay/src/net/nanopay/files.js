FOAM_FILES([
  ...
  { name: 'net/nanopay/tx/ConfirmationPDFLineItem' },
  { name: 'net/nanopay/tx/PDFLineItem' },
  ...
  { name: 'net/nanopay/meter/compliance/ruler/predicate/TransactionStatusPredicate' },
