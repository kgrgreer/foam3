FOAM_FILES([
  ...
  { name: 'net/nanopay/account/ui/addAccountModal/AccountLiquiditySendOnlyViewModel', flags: ['web'] },
  { name: 'net/nanopay/account/ui/addAccountModal/AccountLiquiditySendAndAutoViewModel', flags: ['web'] },
