...
public class AccountHierarchyServiceTest extends Test {
  ...
  public void runTest(X x) {
    ...
    // al2 = new ApproverLevel.Builder(x).setApproverLevel(3).build();
  ...
  public AccountApproverMap foo(X x, CapabilityAccountTemplate template) {
    return null;
    // return service.getAccountsFromCapabilityAccountTemplate(x, template);
  }
