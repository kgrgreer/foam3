...
foam.RELATIONSHIP({
  sourceModel: 'net.nanopay.settlement.SettlementAccount',
  targetModel: 'net.nanopay.settlement.BiLateralAccount',
  inverseName: 'settlementAccount',
  forwardName: 'BiLateralAccounts',
  cardinality: '1:*',
