...
public class CanReceiveCurrencyDAO extends ProxyDAO {
  ...
  public FObject put_(X x, FObject obj) {
    ...
    if ( count.getValue() == 0 ) response.setResponseMessage("The user you've choosen is unable to receive money in that currency.");
    if ( ! isCompliant ) response.setResponseMessage("The user you've choosen hasn't passed our compliance check.");
    return response;
  }
