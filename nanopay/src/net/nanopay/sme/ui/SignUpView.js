        ...
        .then((user) => {
          if ( user && user.twoFactorEnabled ) {
            ...
            if ( !! user ) {
              ...
              this.acceptanceDocumentService.//0 because there is no businessId at this point
              updateUserAcceptanceDocument(this.__context__, this.user.id, 0, this.termsAgreementDocument.id, this.termsAndConditions);

              this.acceptanceDocumentService.//0 because there is no businessId at this point
              updateUserAcceptanceDocument(this.__context__, this.user.id, 0, this.privacyDocument.id, this.termsAndConditions);
            }
