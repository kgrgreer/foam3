foam.CLASS({
  ...
  messages: [
    ...
    { name: 'ERROR_ANNUAL_REVENUE_MESSAGE', message: 'Annual Gross Sales in CAD required.' },
    ...
    { name: 'ERROR_ANNUAL_VOLUME_CAD', message: 'Estimated Annual Volume in CAD required.' },
