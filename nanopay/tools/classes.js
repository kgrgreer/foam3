...
var classes = [
  ...
  'net.nanopay.partner.treviso.api.ArrayOfParcelas',
  'net.nanopay.partner.treviso.api.Boleto',
  ...
  'net.nanopay.partner.treviso.api.InsertBoleto',
  'net.nanopay.partner.treviso.api.InsertBoletoResponse',
  'net.nanopay.partner.treviso.api.InsertTitular',
  'net.nanopay.partner.treviso.api.InsertTitularResponse',
  'net.nanopay.partner.treviso.api.LoginRequest',
  'net.nanopay.partner.treviso.api.LoginResponse',
  'net.nanopay.partner.treviso.api.Natureza',
  'net.nanopay.partner.treviso.api.Parcelas',
  'net.nanopay.partner.treviso.api.Product',
  'net.nanopay.partner.treviso.api.PTaxRate',
  'net.nanopay.partner.treviso.api.PTaxDollarRateResponse',
  'net.nanopay.partner.treviso.api.ResponseBoleto',
  'net.nanopay.partner.treviso.api.ResponseTitular',
  'net.nanopay.partner.treviso.api.ResponsibleArea',
  'net.nanopay.partner.treviso.api.ResponseNatureza',
  ...
  'net.nanopay.partner.treviso.api.SearchBoleto',
  'net.nanopay.partner.treviso.api.SearchBoletoResponse',
  'net.nanopay.partner.treviso.api.SearchCustomerRequest',
  'net.nanopay.partner.treviso.api.SearchCustomerResponse',
  'net.nanopay.partner.treviso.api.SearchNatureza',
  'net.nanopay.partner.treviso.api.SearchNaturezaResponse',
  'net.nanopay.partner.treviso.api.SearchTitular',
  'net.nanopay.partner.treviso.api.SearchTitularResponse',
  'net.nanopay.partner.treviso.api.ServiceStatus',
  'net.nanopay.partner.treviso.api.Signatory',
  'net.nanopay.partner.treviso.api.Template',
  'net.nanopay.partner.treviso.api.Titular',
  'net.nanopay.partner.treviso.api.TrevisoAPIServiceInterface',
  'net.nanopay.partner.treviso.api.UpdateTitular',
