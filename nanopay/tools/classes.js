...
var classes = [
  ...
  'net.nanopay.account.AccountUserJunction',
  ...
  'net.nanopay.invoice.ruler.IsCompletePayment',
   ...
   'net.nanopay.liquidity.roles.Role',
   'net.nanopay.liquidity.roles.RoleRoleJunction',
   'net.nanopay.liquidity.roles.RoleAssignmentTemplate',
   'net.nanopay.liquidity.roles.RoleAssignmentTrunction',
   'net.nanopay.liquidity.rules.account.AccountCreateApproval',
   'net.nanopay.liquidity.rules.account.AccountApprovalsInterceptorDAO',
   'net.nanopay.liquidity.rules.approvalRequest.FulfilledAccountApprovals',
   'net.nanopay.liquidity.rules.approvalRequest.FulfilledAccountApprovalsPredicate',
   'net.nanopay.liquidity.rules.businessRule.LiquidApprovalRequestsOnBusinessRulePut',
   'net.nanopay.liquidity.rules.businessRule.LiquidApprovalRequestsOnBusinessRuleRemove',
   'net.nanopay.liquidity.rules.liquiditySettings.LiquidApprovalRequestsOnLiquiditySettingsPut',
   'net.nanopay.liquidity.rules.liquiditySettings.LiquidApprovalRequestsOnLiquiditySettingsRemove',
   'net.nanopay.liquidity.rules.role.LiquidApprovalRequestsOnRolePut',
   'net.nanopay.liquidity.rules.role.LiquidApprovalRequestsOnRoleRemove',
   'net.nanopay.liquidity.rules.transaction.LiquidApprovalRequestsOnTransactionPut',
   'net.nanopay.liquidity.rules.transaction.LiquidApprovalRequestsOnTransactionRemove',
