...
//    'com.google.dxf.ui.DXFDiagram',
  ...
  css: `
      ...
      ^properties .foam-u2-ActionView:hover { color: white; }
      ^properties .foam-u2-ActionView, ^properties .foam-u2-ActionView:hover { background: white; padding: 2px;  color: black; position: absolute; right: 2px; border: none; margin: 2px 2px 0 0; }
