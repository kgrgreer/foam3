...
foam.CLASS({
  ...
  properties: [
    ...
    },
    {
      ...
      documentation: `
        For cases where the approvable pertains to updating a nested object from a list.
        See  capable.capablePayloads for  example. This is done so that the predicate
        can differentiate between  an approvable for an entire object vs a nested object and
