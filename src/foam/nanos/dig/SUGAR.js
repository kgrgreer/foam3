      ...
      code: async function() {
        if ( this.sugarURL !== '' ) {
          var req = this.HTTPRequest.create({
            url: globalThis.location.protocol + '//' + globalThis.location.hostname + ':' + globalThis.location.port + this.sugarURL + '?data=' + this.postData+ '&sessionId=' + localStorage.defaultSession,
            method: 'POST',
            contentType: 'url'
          }).send();
