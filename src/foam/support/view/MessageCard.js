        ...
        .start('div').addClass('bg')
          .start('hr').end()
            .start().addClass('spaceline')
              ...
              .start()
                .start().add(this.requestName$).addClass('p-legal', 'company-name').end()
                ...
                .callIf(this.message.type == 'Internal', function(){
                  this.start().addClass('p-sm', 'internal-status')
                    .add('Internal Note')
                  .end()
                })
              .end()
              .start().add(this.message.message).addClass('p-sm', 'text').end()
          .end()
        .end();
    }
  ]
