...
// Based on https://www.mobygames.com/game/speedball/screenshots

// Sprites: https://www.cpcwiki.eu/forum/games/cpc-speedball/25/
foam.CLASS({
  package: 'foam.demos.speedball',
  name: 'Ship',
  extends: 'foam.physics.PhysicalCircle',

  requires: [
    'foam.demos.speedballs.Bullet',
...
foam.CLASS({
  ...
  documentation: 'Classic speedballs videogame. Use two gamepads to play.',

  requires: [
    'foam.demos.speedballs.Bullet',
    'foam.demos.speedballs.GravityEngine',
    'foam.demos.speedballs.Ship',
    'foam.animation.Animation',
    'foam.audio.Beep',
    'foam.audio.Speak',
