...
sed -i -e "s/\"from\":\"info@nanopay.net\",\"replyTo\":\"noreply@nanopay.net\",\"displayName\":\"nanopay Corporation\"/\"from\":\"info@connectedcity.net\",\"replyTo\":\"noreply@connectedcity.net\",\"displayName\":\"ConnectedCityc\"/g" ../../nanopay/src/services
