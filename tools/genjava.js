  ...
  //    let cls = loadClass(classes[i]);
  //  //    console.log(cls.model_.instance_.extends);
  //      if ( cls.model_.instance_.extends != undefined && foam.lookup(cls.model_.instance_.extends) != undefined ) {
  //  //    console.log("XOXOXOXO" + classes);
  //      classes.splice(i, 1);
  //      classes.push(cls.id);
  //    }
  //  }
  ...
  //  var javaClasses = classes.map(generateJavaClass);
