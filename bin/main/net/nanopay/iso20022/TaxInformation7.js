...
foam.CLASS({
	...
	properties: [
		...
		},
		{
			...
			name: "Debtor",
			shortName: "Dbtr",
			documentation: "Identifies the party on the debit side of the transaction to which the tax applies.",
		...
		},
		{
			...
			name: "UltimateDebtor",
			shortName: "UltmtDbtr",
			documentation: "Ultimate party that owes an amount of money to the (ultimate) creditor, in this case, to the taxing authority.",
			of: "net.nanopay.iso20022.TaxParty2",
			required: false
		},
		{
		...
		},
		{
			...
			of: "net.nanopay.iso20022.TaxRecord2",
			required: false
		}
	]
});